...
Officer: 5533988
CaseNum: 402-2-84913677-5533988
...
function draw()
{
	...
	if(det.locationX > 515 && det.locationY == 450){
		det.speedX = -1;
		det.speedY = 0;
	}
	if(det.locationX == 515 && det.locationY > 400){
		det.speedX = 0;
		det.speedY = -1;
	}
	if(det.locationX > 322 && det.locationY == 255){
		det.speedX = -1;
		det.speedY = 0;
	}
	if(det.locationX == 322 && det.locationY > 70){
		det.speedX = 0;
		det.speedY = -1;
	}
	if(det.locationX > 130 && det.locationY == 70){
		det.speedX = -1;
		det.speedY = 0;
	}
